...
class ReportCard:
    def __init__(
        ...
        self.results = {}
        self.model_details = model_details if model_details is not None else {}
    ...
    def save(self, output_dir="reports"):
        ...
        with open(cert_path, "w") as f:
            ...
            f.write(f"| :--- | :--- | :--- |\n")
            f.write(
                f"| **TES Score** | **{self.results.get('tes_score', 0.0):.2f}** | Points |\n"
            )
            ...
            if "emissions_kg" in self.results:
                f.write(
                    f"- **Carbon Footprint**: `{self.results['emissions_kg']:.2e} kg CO2`\n"
                )
