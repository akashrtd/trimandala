...
class NBodyDataset(Dataset):
    def __init__(self, h5_file, limit=None):
        self.file = h5_file
        with h5py.File(h5_file, 'r') as f:
            ...
            if limit:
                ...
                # Let's load slice.
                self.pos = f['positions'][:limit+1]
                self.vel = f['velocities'][:limit+1]
            else:
...
def train_model(samples_count):
    ...
    model = SimpleMLP(n_bodies=train_dataset.n_bodies, hidden_size=256) # Smaller model for speed
